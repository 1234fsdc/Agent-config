...
name: search
description: >
  基于Exa的深度研究工具，适用于线索挖掘、文献综述和竞品分析等复杂查询。。Deep research powered by Exa. Use for lead generation, literature reviews, deep dives, competitive analysis, or any query where one search falls short, including phrases like 'research this', 'find everything about', 'find me all', or 'deep dive on'
---
