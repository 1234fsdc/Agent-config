...
description: >
  持久化文件式任务规划，通过磁盘上的计划文件支持多步骤项目，具备会话恢复能力。。Manus-style persistent file-based planning for AI coding agents: keeps task_plan.md, findings.md, and progress.md on disk so work survives context loss and /clear. Use when asked to plan out, break down, or organize a multi-step project, research task, or any work requiring 5+ tool calls. Supports automatic session recovery after /clear
user-invocable: true
