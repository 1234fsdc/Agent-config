...
metadata:
  ...
  version: "1.1"
description: >
  Word文档处理：创建、读取、编辑、修订、评论、格式保留。Complete DOCX document creation, editing, and analysis capabilities with support for revisions, comments, formatting preservation, and text extraction. Use for creating new documents, modifying content, handling revisions, adding comments, or other professional Word document tasks
