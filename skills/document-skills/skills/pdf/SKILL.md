...
metadata:
  ...
  version: "1.1"
description: >
  PDF工具包：报告生成、海报设计、学术论文、提取合并拆分。Professional PDF toolkit covering four production workflows: reports, creative visuals, academic LaTeX, and existing PDF processing. Routes automatically by document type and supports reports, posters, papers, resumes, extraction, merging, splitting, form filling, and format conversion
...
| Process | pikepdf, pdfplumber | LibreOffice (soffice) *(optional)* | N/A | N/A |
